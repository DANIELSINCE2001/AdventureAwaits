  ...
  return (
    <section className="tour-search">
        <div className="container">
          ...
          <htmlForm action="" className="tour-search-form">
            ...
            <div className="input-wrapper">
              ...
              <input type="number" name="people" id="people" required placeholder="No.of People" className="input-field"></input>
            </div>

            <div className="input-wrapper">
              <label htmlFor="checkin" className="input-label">Checkin Date**</label>

              <input type="date" name="checkin" id="checkin" required className="input-field"></input>
            </div>

            <div className="input-wrapper">
              <label htmlFor="checkout" className="input-label">Checkout Date*</label>

              <input type="date" name="checkout" id="checkout" required className="input-field"></input>
            </div>
